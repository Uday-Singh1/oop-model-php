                    ...
                    <table class="w-full table-auto p-2 my-3">
                        ...
                        <tr class="border border-russet">
                            ...
                            <td class="text-right py-1 px-2 underline px-3">
                                <a href="{{ route('project.edit', ['project' => $project->id]) }}">bewerk</a>
                            </td>
                            <td class="text-right py-1 px-2 underline px-3">
                                <form action="{{ route('project.destroy', ['project' => $project->id]) }}" method="POST" onsubmit="return confirm('Weet je zeker dat je dit project wilt verwijderen?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-500 underline ">verwijder</button>
                                </form>
                            </td>
